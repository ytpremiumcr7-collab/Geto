...
class SourceJob(Base):
    ...
    __table_args__ = (
        UniqueConstraint("source_id", "name", name="uq_source_jobs_source_name"),
...
class ProcessedMessage(Base):
    """Idempotencia: un mensaje JetStream (job_id / Nats-Msg-Id) solo se procesa una vez."""

    __tablename__ = "processed_messages"
    __table_args__ = (
        UniqueConstraint("message_id", name="uq_processed_messages_message_id"),
